...
<head>
  ...
  <link href="sweet_alert/sweetalert2.min.css" rel="stylesheet" type="text/css">
...
<body id="page-top">
	...
	?>
	 ...
	 $result_mhs = mysqli_query($connection,"SELECT * FROM mhs,program_studi WHERE mhs.id_program_studi = program_studi.id_program_studi  ORDER BY nrp ASC");
					...
					<table class="table table-striped">
						...
						<tbody>
							...
							while($data_mhs = mysqli_fetch_array($result_mhs)){
                				...
                				echo "<td> <a class='btn btn-success' href='edit_mhs.php?nrp=$data_mhs[nrp]'>Edit</a> 
                ...
                <div>
					<table class="table table-striped">
						...
						<tbody>
							<?php
							$no=1;
							while($data_matakuliah = mysqli_fetch_array($result_matakuliah)){
								echo "<tr>";
								echo "<td>".$no++."</td>";
								echo "<td>".$data_matakuliah['kode']."</td>";
								echo "<td>".$data_matakuliah['matakuliah']."</td>";
								echo "<td>".$data_matakuliah['sks']."</td>";
                				echo "<td> <a class='btn btn-success' href='edit_matkul.php?kode=$data_matakuliah[kode]'>Edit</a> <a class='btn btn-danger' onclick = 'deleteConfirm(event)' href='delete_matkul.php?kode=$data_matakuliah[kode]'><i class='fas fa-trash fa-fw'></i>Delete</a></td></tr>";
							}
							?>
						</tbody>
					</table>
